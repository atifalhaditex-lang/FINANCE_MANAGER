...
function openTransactionForEdit(id) {
    ...
    if (transaction.source) {
        const sourceNames={installment:"Installments",committee:"Committee","credit-withdrawal":"Credit Card","credit-purchase":"Credit Card","credit-purchase":"Credit Card"};
...
function openInstallmentModal(editId = null) {
    ...
    // Use the shared modal engine so aria-hidden is also switched off.
    // The old code only added .show, while CSS still kept the modal hidden
    // because aria-hidden remained "true".
